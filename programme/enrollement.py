...
def enroler_utilisateur(pointeuse_ip="192.168.1.201", user_id=1, name="SAMUEL", finger_index=0, port=4370):
    ...
    try:
        ...
        conn.set_user(uid=int(user_id), name=name, user_id=str(user_id))
